...
public class TpaExecutor implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (!p.hasPermission("xolby.tpa.use")) { p.sendMessage(pl.mm("prefix") + "You lack permission."); return true; }
        if (args.length != 1) { p.sendMessage(pl.mm("prefix") + pl.mm("tpa_usage")); return true; }
